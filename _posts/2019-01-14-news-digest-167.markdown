...
[For Owners of Amazon's **Ring** Security Cameras: Strangers May Have Been Watching Too](https://theintercept.com/2019/01/10/amazon-ring-security-camera/) [(хабр)]()<br/>
...
Єва дуже добре показує, на що схожа війна: 99% нудьги, 1% абсолютного жаху (чи захвату, якщо ви вже трошки того), і ще 1900% пропаганди.
