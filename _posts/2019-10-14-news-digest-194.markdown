...
«libc++ added explicit support for WebAssembly System Interface».
...
[Perl 6 → Raku](https://github.com/perl6/problem-solving/pull/89#pullrequestreview-300789072)<br/>
Ларрі сказав, що можна нарешті змінити назву. 楽, 六, ６, хі-хі.
